...
//        com.philips.easykey.lock.MainActivity.logList.add(0, getSimpleDate() + " " + log);
...
//            intent.setComponent(new ComponentName(context.getPackageName(), com.philips.easykey.lock.PermissionActivity.class.getCanonicalName()));

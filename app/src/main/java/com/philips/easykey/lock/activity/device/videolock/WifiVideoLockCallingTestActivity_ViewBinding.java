...
public class WifiVideoLockCallingTestActivity_ViewBinding implements Unbinder {
  private WifiVideoLockCallingTestActivity target;
  ...
  @UiThread
  public WifiVideoLockCallingTestActivity_ViewBinding(WifiVideoLockCallingTestActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public WifiVideoLockCallingTestActivity_ViewBinding(final WifiVideoLockCallingTestActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    WifiVideoLockCallingTestActivity target = this.target;

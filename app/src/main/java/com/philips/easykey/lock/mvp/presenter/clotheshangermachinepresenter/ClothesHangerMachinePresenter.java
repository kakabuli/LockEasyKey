...
import com.philips.easykey.lock.publiclibrary.bean.ClothesHangerMachineAllStatusBean;
...
import com.philips.easykey.lock.publiclibrary.mqtt.publishbean.ClothesHangerMachineBean.ClothesHangerMachineOnlineBean;
import com.philips.easykey.lock.publiclibrary.mqtt.publishbean.ClothesHangerMachineBean.ClothesHangerMachineStatusBean;
...
import com.philips.easykey.lock.publiclibrary.mqtt.publishresultbean.ClothesHangerMachineBean.SetHangerAirDryResult;
import com.philips.easykey.lock.publiclibrary.mqtt.publishresultbean.ClothesHangerMachineBean.SetHangerChildLockResult;
            ...
            listenerHangerOnline = mqttService.listenerDataBack()
                    ...
                    .subscribe(new Consumer<MqttData>() {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            ...
                            LogUtils.d("shulan CLOTHES_HANGER_MACHINE_ONLINE-->" + onlineBean.toString());
            ...
            getHangerAllStatus = mqttService.mqttPublish(MqttConstant.getCallTopic(MyApplication.getInstance().getUid()),
                    ...
                    .subscribe(new Consumer<MqttData>() {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            ...
                            LogUtils.d("shulan CLOTHES_HANGER_MACHINE_GET_ALL_STATUS-->" + result.toString());
            ...
            setBakingDisposable = mqttService.mqttPublish(MqttConstant.getCallTopic(MyApplication.getInstance().getUid()),
                    ...
                    .subscribe(new Consumer<MqttData>() {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            ...
                            LogUtils.d("shulan CLOTHES_HANGER_MACHINE_SET_BACKING-->" + result.toString());
        ...
        if(mqttService != null){
            ...
            setAirDryDisposable = mqttService.mqttPublish(MqttConstant.getCallTopic(MyApplication.getInstance().getUid()),
                    ...
                    .subscribe(new Consumer<MqttData>() {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            SetHangerAirDryResult result = new Gson().fromJson(mqttData.getPayload(), SetHangerAirDryResult.class);
                            LogUtils.d("shulan CLOTHES_HANGER_MACHINE_SET_AIR_DRY-->" + result.toString());
                            /*if ("200".equals(result.getCode() + "")) { //请求成功
                                if(isSafe()){
            ...
            setChildLockDisposable = mqttService.mqttPublish(MqttConstant.getCallTopic(MyApplication.getInstance().getUid()),
                    ...
                    .subscribe(new Consumer<MqttData>() {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            ...
                            LogUtils.d("shulan CLOTHES_HANGER_MACHINE_SET_CHILD_LOCK-->" + result.toString());
                            if ("200".equals(result.getCode() + "")) { //请求成功
                                if(isSafe()){
        ...
        if(mqttService != null){
            ...
            setVoiceDisposable = mqttService.mqttPublish(MqttConstant.getCallTopic(MyApplication.getInstance().getUid()),
                    ...
                    .subscribe(new Consumer<MqttData>() {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            SetHangerChildLockResult result = new Gson().fromJson(mqttData.getPayload(), SetHangerChildLockResult.class);
                            LogUtils.d("shulan CLOTHES_HANGER_MACHINE_SET_LOUD_SPEAKER-->" + result.toString());
                            if ("200".equals(result.getCode() + "")) { //请求成功
                                if(isSafe()){
        ...
        if(mqttService != null){
            ...
            setUVDisposable = mqttService.mqttPublish(MqttConstant.getCallTopic(MyApplication.getInstance().getUid()),
                    ...
                    .subscribe(new Consumer<MqttData>() {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            SetHangerAirDryResult result = new Gson().fromJson(mqttData.getPayload(), SetHangerAirDryResult.class);
                            LogUtils.d("shulan CLOTHES_HANGER_MACHINE_SET_UV-->" + result.toString());
                            /*if ("200".equals(result.getCode() + "")) { //请求成功
                                if(isSafe()){
        ...
        if(mqttService != null){
            ...
            setLightingDisposable = mqttService.mqttPublish(MqttConstant.getCallTopic(MyApplication.getInstance().getUid()),
                    ...
                    .subscribe(new Consumer<MqttData>() {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            SetHangerAirDryResult result = new Gson().fromJson(mqttData.getPayload(), SetHangerAirDryResult.class);
                            LogUtils.d("shulan CLOTHES_HANGER_MACHINE_SET_LIGHTING-->" + result.toString());
                            if ("200".equals(result.getCode() + "")) { //请求成功
                                if(isSafe()){
            ...
            setMotorDisposable = mqttService.mqttPublish(MqttConstant.getCallTopic(MyApplication.getInstance().getUid()),
                    ...
                    .subscribe(new Consumer<MqttData>() {
                        ...
                        public void accept(MqttData mqttData) throws Exception {
                            ...
                            LogUtils.d("shulan CLOTHES_HANGER_MACHINE_SET_MOTOR-->" + result.toString());
                            if ("200".equals(result.getCode() + "")) { //请求成功
                                if(isSafe()){

...
public class AlertDialogUtil {
    ...
    public void PhilipsSingleButtonDialog(Context context, String title, String content, String query, ClickListener clickListener) {
        View mView = LayoutInflater.from(context).inflate(R.layout.philips_singlebutton_dialog, null);
        TextView tvTitle = mView.findViewById(R.id.tv_title);
        TextView tvContent = mView.findViewById(R.id.tv_content);
        TextView tv_query = mView.findViewById(R.id.tv_button);
        AlertDialog alertDialog = AlertDialogUtil.getInstance().common(context, mView);
...
//                LogUtils.d("--kaadas--","输入结束后的内容为 [" + s.toString()+" ] 即将显示在屏幕上");
    ...
    public void titleTwoButtonPhilipsDialog(Context context, String title,String content,String left, String right, String leftColor, String rightColor, ClickListener clickListener) {
        View mView = LayoutInflater.from(context).inflate(R.layout.philips_title_two_button_dialog, null);
        TextView tvTitle = mView.findViewById(R.id.tv_title);
        TextView tvContent = mView.findViewById(R.id.tv_content);
        TextView tv_cancel = mView.findViewById(R.id.tv_left);
        TextView tv_query = mView.findViewById(R.id.tv_right);
    ...
    public void statementAndTermsDialog(Context context, String title, String content, String left, String right, ClickListener clickListener){
        ...
        tv_cancel.setText(left);
        tv_query.setText(right);
        String privacyPolicyStr = context.getResources().getString(R.string.philips_privacy_policy);

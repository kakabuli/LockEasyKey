...
import com.philips.easykey.lock.mvp.presenter.wifilock.videolock.WifiVideoLockVoiceQualitySettingPresenter;
...
public class PhilipsWifiVideoLockVoiceQualitySettingActivity extends BaseActivity<IWifiVideoLockVoiceQualitySettingView, WifiVideoLockVoiceQualitySettingPresenter<IWifiVideoLockVoiceQualitySettingView>> implements IWifiVideoLockVoiceQualitySettingView  , View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rlVoiceMute = findViewById(R.id.rl_voice_mute);
        rlVoiceLow = findViewById(R.id.rl_voice_low);
        rlVoiceHigh = findViewById(R.id.rl_voice_high);
        ckVoiceMute = findViewById(R.id.ck_voice_mute);
        ckVoiceLow = findViewById(R.id.ck_voice_low);
        ckVoiceHigh = findViewById(R.id.ck_voice_high);
        avi = findViewById(R.id.avi);
        tvTips = findViewById(R.id.tv_tips);
        ivBack.setOnClickListener(this);
        rlVoiceMute.setOnClickListener(this);
        rlVoiceLow.setOnClickListener(this);
        rlVoiceHigh.setOnClickListener(this);
    ...
    public void onSettingCallBack(boolean flag) {
        if(!PhilipsWifiVideoLockVoiceQualitySettingActivity.this.isFinishing()){
            ...
            mPresenter.handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if(flag){
                        ...
                        Intent intent;
                        if(BleLockUtils.isSupportXMConnect(wifiLockInfo.getFunctionSet())){
                            intent = new Intent(PhilipsWifiVideoLockVoiceQualitySettingActivity.this, PhilipsWifiVideoLockMoreActivity.class);
                        }else {
                            intent = new Intent(PhilipsWifiVideoLockVoiceQualitySettingActivity.this, WifiLockMoreActivity.class);
                        }

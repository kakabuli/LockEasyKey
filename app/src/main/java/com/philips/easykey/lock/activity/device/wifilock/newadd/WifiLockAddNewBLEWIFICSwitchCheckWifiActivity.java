...
import com.philips.easykey.lock.mvp.presenter.wifilock.WifiLockBleToWifiSetUpPresenter;
import com.philips.easykey.lock.mvp.view.wifilock.IWifiLockBleToWifiSetUpView;
...
//                socketManager.destroy();
                ToastUtils.showShort(getString(R.string.bind_failed) + errorCode);
                Intent intent = new Intent(WifiLockAddNewBLEWIFICSwitchCheckWifiActivity.this, WifiLockAddNewBindFailedActivity.class);
                startActivity(intent);
//                if (errorCode == -1) {

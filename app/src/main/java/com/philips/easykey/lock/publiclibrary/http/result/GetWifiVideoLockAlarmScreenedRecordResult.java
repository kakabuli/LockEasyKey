...
public class GetWifiVideoLockAlarmScreenedRecordResult extends BaseResult {
    ...
    public class Data
    {
        private List<WifiVideoLockAlarmRecord> alarmList;

        public void setAlarmList(List<WifiVideoLockAlarmRecord> alarmList){
            this.alarmList = alarmList;
        }
        public List<WifiVideoLockAlarmRecord> getAlarmList(){

...
import com.philips.easykey.lock.mvp.presenter.gatewaylockpresenter.GatewayLockMorePresenter;
...
public class GatewayMoreActivity extends BaseActivity<GatewayLockMoreView, GatewayLockMorePresenter<GatewayLockMoreView>>
    ...
    public void getSoundVolumeFail() {
      /*  if (!TextUtils.isEmpty(gatewayId) && !TextUtils.isEmpty(deviceId)) {
        ...
        ToastUtils.showShort(R.string.philips_activity_gateway_more_failed);

...
-keepclassmembers class com.philips.easykey.lock.utils.KeyConstants {
...
#
-keep class com.philips.easykey.lock.bean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.bean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.ble.bean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.ble.responsebean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.http.postbean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.http.result.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.http.temp.postbean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.http.temp.resultbean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.mqtt.eventbean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.mqtt.publishbean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.mqtt.publishresultbean.**{*;}
-keep class com.philips.easykey.lock.publiclibrary.mqtt.PowerResultBean{*;}
-keep class com.philips.easykey.lock.publiclibrary.mqtt.PublishResult{*;}
-keep class com.philips.easykey.lock.publiclibrary.xm.bean.**{*;}
-keep class com.philips.easykey.lock.utils.greenDao.bean.**{*;}
